...
export interface Role {
  ...
  logo_variant: "tile" | "plate" | null;
  logo_aspect: number | null;
  logo_placement: "right" | "below" | null;
  fr_role?: string;
  fr_summary?: string;
  fr_outcome?: string;
  fr_achievements?: string[];
}
            ...
            >
              ...
              <div
                className={`${styles.detailCol} ${
                  r.logo_placement === "below" ? styles.logoBelow : ""
                }`}
              >
                ...
                <div className={styles.logoCol}>
                  {r.logo_image ? (
                    <span
                      className={`${styles.logoWrap} ${r.logo_variant ? styles[r.logo_variant] : ""}`}
                      style={
                        r.logo_variant === "plate" && r.logo_aspect
                          ? ({ "--logo-aspect": r.logo_aspect } as React.CSSProperties)
                          : undefined
                      }
                    >
                      ...
                      <img src={r.logo_image} alt={`${r.company} logo`} />
                    </span>
                  ) : (
