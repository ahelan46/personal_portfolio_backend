          ...
          {certs.map((c, i) => {
            ...
            return (
              <article className={cls} key={c.title} style={{ zIndex: 200 - i }}>
                  ...
                  {c.logo_image ? (
                    <span className={styles.logoPlate}>
                      <img
                        src={c.logo_image}
                        alt={c.issuer ?? ""}
                        style={{ aspectRatio: c.logo_aspect ?? 1 }}
                      />
                    </span>
                  ) : null}
                ...
                <h3 className={styles.title}>{lang === "fr" && c.fr_title ? c.fr_title : c.title}</h3>

                <div className={styles.detail}>
                  {c.metric_value && (
                    <div className={styles.metric}>
                      <span className={styles.metricValue}>{c.metric_value}</span>
                      <span className={styles.metricLabel}>
                        {(lang === "fr" && c.fr_metric_label) || c.metric_label}
                      </span>
                    </div>
                  )}
