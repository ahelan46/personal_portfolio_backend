            ...
            <div className={styles.overlay} aria-hidden="true">
              ...
              {chapters.map((c) => (
                <article className={styles.chapter} key={c.id}>
                  ...
                  <p className={styles.chPlace}>{isFr && c.fr_place ? c.fr_place : c.place}</p>
                  <p className={styles.chStory}>{isFr && c.fr_story ? c.fr_story : c.story}</p>
                  <p className={styles.chBridge}>
                    <i aria-hidden="true">→</i> {isFr && c.fr_bridge ? c.fr_bridge : c.bridge}
                  </p>
                </article>
              ))}
          ...
          <ol>
            {chapters.map((c) => (
              <li key={c.id}>
                ...
                <p className={styles.staticPlace}>{isFr && c.fr_place ? c.fr_place : c.place}</p>
                <p>{isFr && c.fr_story ? c.fr_story : c.story}</p>
                <p className={styles.staticBridge}>{isFr && c.fr_bridge ? c.fr_bridge : c.bridge}</p>
              </li>
            ))}
          </ol>
        </div>
